...
def main():
    ...
    X = np.genfromtxt("/content/drive/MyDrive/fdsa.program/dataset/iris.csv", delimiter=",", usecols=(0,1,2,3), skip_header=1)
    y = np.genfromtxt("/content/drive/MyDrive/fdsa.program/dataset/iris.csv", delimiter=",", usecols=4, skip_header=1, dtype=str)
